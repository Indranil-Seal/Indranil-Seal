...
![Agile](https://img.shields.io/badge/Agile-00B4D8?style=for-the-badge&logoColor=white)
...
- **XIS Framework**: Developed a bootstrap-based Share of Market estimation framework for newly launched pharmaceutical brands using short-tenure (~6 months) multichannel data
- **Oncology Classification**: MCL/CLL & EBC/MBC patient classification using **LightGBM** with Synthetic Imputation for missing Px/Dx data — enabling targeted identification for **Jaypirca** and **Verzenio**
- **Market Mix Modelling**: Measured ROI and marginal ROI (m-ROI) from promotional channels to optimise commercial spend across the HCP universe
- **360° Experiment Tracking**: Engineered a global agile-based experiment tracking framework with summaries, timelines, and power analysis dashboards
...
- **Patient-HCP Network Analysis**: Network mapping of Patient–HCP migration using APLD data to build patient journey maps, enabling an HCP-HCP recommendation engine
...
- **Energy Analytics**: Industrial asset performance prediction and control simulation using **GAM & Random Forest**, connected to PTC Thingworx via Web API
